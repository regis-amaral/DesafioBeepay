...
class ValidationPatientMessages
{
    ...
    public static function patientRequestMessages(): array
    {
        return [
            ...
            'address.cep.required_with' => 'O CEP é obrigatório quando o endereço é fornecido.',
            ...
            'address.street.required_with' => 'O campo de rua é obrigatório quando o endereço é fornecido.',
            ...
            'address.number.required_with' => 'O campo de número é obrigatório quando o endereço é fornecido.',
            ...
            'address.complement.required_with' => 'O campo de complemento é obrigatório quando o endereço é fornecido.',
            ...
            'address.neighborhood.required_with' => 'O campo de bairro é obrigatório quando o endereço é fornecido.',
            ...
            'address.city.required_with' => 'O campo de cidade é obrigatório quando o endereço é fornecido.',
            ...
            'address.state.required_with' => 'O campo de estado é obrigatório quando o endereço é fornecido.',
